...
HD_PWD='c:/ece532/hdmi_final/hdmi/ip/managed_ip_project/managed_ip_project.tmp/overlay_v1_0_v1_0_project/overlay_v1_0_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overlay_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source overlay_v1_0.tcl
